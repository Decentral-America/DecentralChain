...
const {
  keyPair, publicKey, privateKey, address, seedWithNonce,
  signBytes, verifySignature, verifyPublicKey, verifyAddress,
  blake2b, keccak, sha256,
  base58Encode, base58Decode, base64Encode, base64Decode,
  base16Encode, base16Decode,
  stringToBytes, bytesToString,
  randomBytes, randomSeed,
  sharedKey, messageEncrypt, messageDecrypt,
