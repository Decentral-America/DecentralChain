...
>>>>>>> 591daad2 (feat!: modernize to ESM, TypeScript 5.9, Vitest, tsup):test/integration/smart.spec.ts
  ...
  describe('Data transactions', () => {
    it(
      'Should set data of all types and delete it',
      async () => {
        const dataTx = data(
          {
            chainId: CHAIN_ID,
  ...
  describe('dApp', () => {
    it(
      ...
      */
        try {
          const script =
            'AAIDAAAAAAAAAAcIARIDCgEBAAAAAAAAAAEAAAABaQEAAAADZm9vAAAAAQAAAAFhCQEAAAALVHJhbnNmZXJTZXQAAAABCQAETAAAAAIJAQAAAA5TY3JpcHRUcmFuc2ZlcgAAAAMIBQAAAAFpAAAABmNhbGxlcgUAAAABYQUAAAAEdW5pdAUAAAADbmlsAAAAABk8wBI=';
          const txParams: ISetScriptParams = {
            chainId: CHAIN_ID,
            script,
          };
