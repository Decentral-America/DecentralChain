...
| blockchain-postgres-sync | `apps/blockchain-postgres-sync` | [wavesplatform/blockchain-postgres-sync](https://github.com/wavesplatform/blockchain-postgres-sync) | `8c0b0c9b` (May 25 2026) | `a8c55235` | 2026-06-23 | 🟢 Active | ✅ fully synced — upstream HEAD |
