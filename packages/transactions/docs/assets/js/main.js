!((e) => {
  ...
  (r.m = e),
    ...
    (r.t = (e, t) => {
      ...
      if (
        ...
        for (var i in e) r.d(n, i, ((t) => e[t]).bind(null, i));
      return n;
    }),
    (r.n = (e) => {
     ...
     */ !(function () {
      ...
      (C.version = '2.3.9'),
        ...
        (C.utils.warn =
          ((s = this),
          (e) => {
            s.console && console.warn?.(e);
          })),
        (C.utils.asString = (e) => (null == e ? '' : e.toString())),
        (C.utils.clone = (e) => {
          if (null == e) return e;
        ...
        (C.Token.prototype.clone = function (e) {
          return (e = e || ((e) => e)), new C.Token(e(this.str, this.metadata), this.metadata);
        }),
        /*!
         * lunr.tokenizer
         * Copyright (C) 2020 Oliver Nightingale
         */ (C.tokenizer = (e, t) => {
          ...
          if (Array.isArray(e))
            return e.map((e) => new C.Token(C.utils.asString(e).toLowerCase(), C.utils.clone(t)));
          for (
        ...
        (C.Pipeline.prototype.toJSON = function () {
          return this._stack.map((e) => (C.Pipeline.warnIfFunctionNotRegistered(e), e.label));
        }),
        /*!
         * lunr.Vector
         * Copyright (C) 2020 Oliver Nightingale
         ...
         */ (C.stemmer =
          ...
          (a = { alize: 'al', ative: '', ful: '', ical: 'ic', icate: 'ic', iciti: 'ic', ness: '' }),
          (u = '[aeiouy]'),
          (l = '[^aeiou][^aeiouy]*'),
          (c = /^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*/),
          (h =
            /^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*/),
          (d = /^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$/),
          (f = /^([^aeiou][^aeiouy]*)?[aeiouy]/),
          (p = /^(.+?)(ss|i)es$/),
          (y = /^(.+?)([^s])s$/),
          (m = /^(.+?)eed$/),
          (v = /^(.+?)(ed|ing)$/),
         ...
         * lunr.trimmer
         * Copyright (C) 2020 Oliver Nightingale
         */ (C.trimmer = (e) => e.update((e) => e.replace(/^\W+/, '').replace(/\W+$/, ''))),
          ...
          for (var r = new C.TokenSet(), n = [{ editsRemaining: t, node: r, str: e }]; n.length; ) {
            ...
            if (i.str.length > 0) {
              ...
              o in i.node.edges
                ...
                n.push({ editsRemaining: i.editsRemaining, node: s, str: i.str.slice(1) });
            }
            if (0 !== i.editsRemaining) {
              ...
              if (
                ...
                n.push({ editsRemaining: i.editsRemaining - 1, node: a, str: i.str }),
                i.str.length > 1 &&
                  n.push({
                ...
                1 === i.str.length && (u.final = !0),
                  n.push({ editsRemaining: i.editsRemaining - 1, node: u, str: i.str.slice(1) });
              }
              if (i.str.length > 1) {
                var l,
                  c = i.str.charAt(0),
        ...
        (C.TokenSet.prototype.toArray = function () {
          for (var e = [], t = [{ node: this, prefix: '' }]; t.length; ) {
            var r = t.pop(),
            ...
            for (var s = 0; s < i; s++) {
              var o = n[s];
              t.push({ node: r.node.edges[o], prefix: r.prefix.concat(o) });
            }
          }
          return e;
        }),
        ...
        (C.TokenSet.prototype.intersect = function (e) {
          for (
            var t = new C.TokenSet(), r = void 0, n = [{ node: this, output: t, qNode: e }];
            n.length;
          ) {
            r = n.pop();
            for (
              ...
              for (var l = i[u], c = 0; c < a; c++) {
                ...
                if (h === l || '*' === l) {
                  ...
                  h in r.output.edges
                    ...
                    n.push({ node: d, output: y, qNode: f });
                }
              }
          }
          return t;
        ...
        (C.TokenSet.Builder.prototype.insert = function (e) {
          ...
          for (n = r; n < e.length; n++) {
            var i = new C.TokenSet(),
              s = e[n];
            (t.edges[s] = i), this.uncheckedNodes.push({ char: s, child: i, parent: t }), (t = i);
          }
              ...
              for (var m = 0; m < p.length; m++) {
                ...
                for (y = 0; y < u.fields.length; y++) {
                  ...
                  if (
                    ...
                    if ((n[R].upsert(x, u.boost, (e, t) => e + t), !i[E])) {
          ...
          for (a = 0; a < I.length; a++) {
            ...
            if (T.contains(D) && !_.contains(D)) {
              ...
              if (void 0 !== (A = F[D])) (A.score += q), A.matchData.combine(r[N]);
                ...
                var V = { matchData: r[N], ref: D, score: q };
                (F[D] = V), j.push(V);
              }
            }
          }
          return j.sort((e, t) => t.score - e.score);
        }),
        ...
        (C.Index.load = (e) => {
          ...
          e.version !== C.version &&
            C.utils.warn(
              `Version mismatch when loading serialised index. Current version of lunr '${C.version}' does not match serialized index '${e.version}'`,
            );
        ...
        (C.Query.presence = { OPTIONAL: 1, PROHIBITED: 3, REQUIRED: 2 }),
        ...
        (C.QueryLexer.prototype.emit = function (e) {
          this.lexemes.push({ end: this.pos, start: this.start, str: this.sliceString(), type: e }),
            (this.start = this.pos);
        }),
        ...
        (C.QueryLexer.lexField = (e) => (
          e.backup(), e.emit(C.QueryLexer.FIELD), e.ignore(), C.QueryLexer.lexText
        )),
        (C.QueryLexer.lexTerm = (e) => {
          if ((e.width() > 1 && (e.backup(), e.emit(C.QueryLexer.TERM)), e.ignore(), e.more()))
            return C.QueryLexer.lexText;
        }),
        (C.QueryLexer.lexEditDistance = (e) => (
          e.ignore(), e.acceptDigitRun(), e.emit(C.QueryLexer.EDIT_DISTANCE), C.QueryLexer.lexText
        )),
        (C.QueryLexer.lexBoost = (e) => (
          e.ignore(), e.acceptDigitRun(), e.emit(C.QueryLexer.BOOST), C.QueryLexer.lexText
        )),
        (C.QueryLexer.lexEOS = (e) => {
          e.width() > 0 && e.emit(C.QueryLexer.TERM);
        }),
        (C.QueryLexer.termSeparator = C.tokenizer.separator),
        (C.QueryLexer.lexText = (e) => {
          for (;;) {
            var t = e.next();
            ...
            if (92 !== t.charCodeAt(0)) {
              ...
              if ('^' === t)
                return (
                  e.backup(), e.width() > 0 && e.emit(C.QueryLexer.TERM), C.QueryLexer.lexBoost
                );
              if ('+' === t && 1 === e.width())
        ...
        (C.QueryParser.parseField = (e) => {
          var t = e.consumeLexeme();
          if (null != t) {
            if (-1 === e.query.allFields.indexOf(t.str)) {
              var r = e.query.allFields.map((e) => `'${e}'`).join(', '),
        ...
        (C.QueryParser.parseEditDistance = (e) => {
          var t = e.consumeLexeme();
          if (null != t) {
        ...
        void 0 === (i = 'function' === typeof (n = () => C) ? n.call(t, r, t, e) : n) ||
          (e.exports = i);
    })();
  },
  (_e, _t, _r) => {},
  (_e, t, r) => {
    ...
    var n = [];
    function i(e, t) {
      n.push({ constructor: e, selector: t });
    }
    var s,
      o,
      a = (() => {
        ...
        return (
          (e.prototype.createComponents = (e) => {
            n.forEach((t) => {
              e.querySelectorAll(t.selector).forEach((e) => {
        ...
        return (
          ...
          (t.prototype.loadIndex = function () {
            if (this.loadingState === o.Idle && !this.data) {
              setTimeout(() => {
                this.loadingState === o.Idle && this.setLoadingState(o.Loading);
              }, 500);
              ...
              t
                ? fetch(t)
                    ...
                    .then((t) => {
                      (this.data = t),
                        (this.index = l.Index.load(t.index)),
                        this.setLoadingState(o.Ready);
                    })
                    .catch((t) => {
                      console.error(t), this.setLoadingState(o.Failure);
                    })
            ...
            if (
              ...
              for (var t = 0, r = Math.min(10, e.length); t < r; t++) {
                var n = this.data.rows[Number(e[t].ref)],
                  i = n.name.replace(new RegExp(this.query, 'i'), (e) => `<b>${e}</b>`),
                  s = n.parent || '';
                (s = s.replace(new RegExp(this.query, 'i'), (e) => `<b>${e}</b>`)) &&
          ...
          (t.prototype.bindEvents = function () {
            this.results.addEventListener('mousedown', () => {
              this.resultClicked = !0;
            }),
              this.results.addEventListener('mouseup', () => {
                (this.resultClicked = !1), this.setHasFocus(!1);
              }),
              this.field.addEventListener('focusin', () => {
                this.setHasFocus(!0), this.loadIndex();
              }),
              this.field.addEventListener('focusout', () => {
                this.resultClicked
                  ? (this.resultClicked = !1)
                  : setTimeout(() => this.setHasFocus(!1), 100);
              }),
              this.field.addEventListener('input', () => {
                this.setQuery(this.field.value);
              }),
              this.field.addEventListener('keydown', (t) => {
                    ...
                    13 === t.keyCode
                      ...
                      : 27 === t.keyCode
                        ...
                        : 38 === t.keyCode
                          ...
                          : 40 === t.keyCode && this.setCurrentResult(1))
                  : (this.preventPress = !1);
              }),
              this.field.addEventListener('keypress', (t) => {
                this.preventPress && t.preventDefault();
              }),
              document.body.addEventListener('keydown', (t) => {
                t.altKey ||
                  t.ctrlKey ||
                  t.metaKey ||
                  (!this.hasFocus && t.keyCode > 47 && t.keyCode < 112 && this.field.focus());
              });
          }),
          t
        );
        ...
        return (
          ...
          (t.prototype.triggerResize = function () {
            var e = new CustomEvent('resize', {
              detail: { height: this.height, width: this.width },
            });
      ...
      v = ((e) => {
        function t(t) {
          ...
          return (
            (r.anchors = []),
            (r.index = -1),
            y.instance.addEventListener('resize', () => r.onResize()),
            y.instance.addEventListener('scroll', (e) => r.onScroll(e)),
            r.createAnchors(),
            r
          );
        }
              ...
              this.el.querySelectorAll('a').forEach((r) => {
                ...
                if (-1 !== n.indexOf('#') && n.substr(0, t.length) === t) {
                  var i = n.substr(n.indexOf('#') + 1),
                    ...
                    o = r.parentNode;
                  s && o && this.anchors.push({ anchor: s, link: o, position: 0 });
                }
              }),
              this.onResize();
          }),
        ...
        function t(t) {
          ...
          return (
            ...
            r.container &&
              ...
              Array.from(r.el.children).forEach((e) => {
                e.addEventListener('touchstart', (e) => r.onClick(e)),
                  e.addEventListener('click', (e) => r.onClick(e));
              }),
    ...
    var T = (() => {
      ...
      _ = ((e) => {
        function t(t) {
          ...
          return (
            ...
            r.el.addEventListener(b, (e) => r.onPointerUp(e)),
            r.el.addEventListener('click', (e) => e.preventDefault()),
            document.addEventListener(L, (e) => r.onDocumentPointerDown(e)),
            document.addEventListener(b, (e) => r.onDocumentPointerUp(e)),
            r
          );
        }
        return (
          ...
          (t.prototype.setActive = function (e) {
            if (this.active !== e) {
              ...
              document.documentElement.classList.add(t),
                setTimeout(() => document.documentElement.classList.remove(t), 500);
            }
          }),
      ...
      I = ((e) => {
        ...
        return (
          ...
          (t.prototype.handleValueChange = function (_e, _t) {
            this.checkbox &&
          ...
          (t.prototype.fromLocalStorage = (e) => 'true' === e),
          (t.prototype.toLocalStorage = (e) => (e ? 'true' : 'false')),
          t
        );
      })(R),
      j = ((e) => {
        ...
        return (
          ...
          (t.prototype.initialize = function () {
            ...
            if (t) {
              ...
              this.select.addEventListener(L, r),
                ...
                this.select.querySelectorAll('li').forEach((r) => {
                  r.addEventListener(b, (r) => {
                    t.classList.remove('active'), this.setValue(r.target.dataset.value || '');
                  });
                }),
                document.addEventListener(L, (t) => {
                  this.select.contains(t.target) || this.select.classList.remove('active');
                });
            }
          }),
          ...
          (t.prototype.fromLocalStorage = (e) => e),
          (t.prototype.toLocalStorage = (e) => e),
          t
        );
      })(R),
      F = ((e) => {
