...
public class P1 {
  ...
  public P1 hash_to(byte[] msg, String DST, byte[] aug) { blstJNI.P1_hash_to(swigCPtr, msg, DST, aug); return this; }

  public P1 encode_to(byte[] msg, String DST, byte[] aug) { blstJNI.P1_encode_to(swigCPtr, msg, DST, aug); return this; }
