...
public class LeaseTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        return Stream.of(
                arguments(1, minAlias, 1, Id.as("4HcJAJJSmPVLw2kyZH1AUen1VDKaG3DHr8cgRJLpfNc6"),
                        ...
                        Base64.decode("CI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AlIABHJpY2gAAAAAAAAAAQAAAAAAAYagAAABdIdugAA="),
                        Base64.decode("CI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AlIABHJpY2gAAAAAAAAAAQAAAAAAAYagAAABdIdugADvXjnExC0WqqQk+bcYM5a2GfXHZK/ObAIymZVEX+45iVWMZ5CXB6OJurtFBqNg+if2oSMciIvLxNvzOMuWCPaF"),
                ...
                arguments(1, maxAlias, Long.MAX_VALUE, Id.as("2k76csSZ1761KGBLR95zqKQ1KnoTVkMomg5NfV1W9wGN"),
                        Proof.list(Proof.as("nHvAeVrWkTcw4BxoWuBwj3NVHuRi289RvNREWN14fjEjj3xXN5fcZi7mRcTrPa91SMUoENG8TRt3ZB3HZKPQgbW")),
                        Base64.decode("CI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AlIAHl9yaWNoLWFjY291bnQud2l0aEAzMF9zeW1ib2xzX3//////////AAAAAAABhqAAAAF0h26AAA=="),
                        Base64.decode("CI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AlIAHl9yaWNoLWFjY291bnQud2l0aEAzMF9zeW1ib2xzX3//////////AAAAAAABhqAAAAF0h26AACcOzOZXDTE7bG+k17Fa0To+VVox1bU///zDGPcxit2ztvoWxWl+J/UUvZAho8b9oeBzLhfh/RiYgQTeR38rnIU="),
                ...
                arguments(1, address, Long.MAX_VALUE, Id.as("BMt7mhihgaMqfKYomTo8cRrJgcsMMszJakDgtRuSWo9r"),
                        Proof.list(Proof.as("JNoppNTJfaasQ8NVdJmqub5ZULkcUHJBTBmrzsN6kGNv4Cs3wTbKmF3soxjf3qW1zSJq6jM8jc5PNCEtb1LcLKb")),
                        Base64.decode("CI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AVInicmF011n1oXcDpi6LyFthr6PvAaApjB//////////wAAAAAAAYagAAABdIdugAA="),
                        Base64.decode("CI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AVInicmF011n1oXcDpi6LyFthr6PvAaApjB//////////wAAAAAAAYagAAABdIdugAAO/AEopPRKef6isFkm1iohtiFqXZjKnthq7d5yLHPdPZVFD7IEW28avmOC9l5TjYoS+hQloZ8L6OnU9Kpgb4SK"),
                ...
                arguments(2, minAlias, 1, Id.as("8FYbDJnzetZ7BKdkDFWaPWaFhXbKRJPrPcNYGidtjeXy"),
                        Proof.list(Proof.as("W4ryRuxJPjpSUWLjtT4zyVixPi6N6iRk2zNUSiBqH2KMycvQYK4M3GVBpoT8BbzyxRN5BiGts4oP8B9cLTVGX8V")),
                        Base64.decode("CAIAjY+yjcB1fArFRi26YEYA7BeLB3tUgJK6I9GKMWhjN3QCUgAEcmljaAAAAAAAAAABAAAAAAABhqAAAAF0h26AAA=="),
                        Base64.decode("AAgCAI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AlIABHJpY2gAAAAAAAAAAQAAAAAAAYagAAABdIdugAABAAEAQBkQ38kMOoh8lWntPrJhj3G4ueB6HVNBbWJq705HGqZFQUqT1MP+5g7nRqp7leIa0vyaLl3Is6sXpprx+hD0MoI="),
                ...
                arguments(2, maxAlias, Long.MAX_VALUE, Id.as("B4a2ADiQx61paTNS4CVuRj7XQZxbZib4u23JRiE5HCB1"),
                        Proof.list(Proof.as("2rYT5eKQHwyzzYthcqabK5VRjKe5Xs17vhTAhsBTH6a7Uze1sg7M5iYu9KiAouW6TZrYcDKiFpHDc2Rp8TD5Y66Z")),
                        Base64.decode("CAIAjY+yjcB1fArFRi26YEYA7BeLB3tUgJK6I9GKMWhjN3QCUgAeX3JpY2gtYWNjb3VudC53aXRoQDMwX3N5bWJvbHNff/////////8AAAAAAAGGoAAAAXSHboAA"),
                        Base64.decode("AAgCAI2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0AlIAHl9yaWNoLWFjY291bnQud2l0aEAzMF9zeW1ib2xzX3//////////AAAAAAABhqAAAAF0h26AAAEAAQBAXL2HCBSaBqR8odtIcD3/lLpixHfPxC6pTpuC+lOomB1s94WLSj6BD5W739bbMogkJrs98iiNhpSZJBcL1w/sjg=="),
                ...
                arguments(3, minAlias, 1, Id.as("65jwmmr3Yb3z2iNUMSUQuqF7PRPckhB8Z7MUgQiBXxLh"),
                        Proof.list(Proof.as("3mYdtrBDiizLESUQ88ZF3Bi9Xt8nM4FwYpDPVfSA5JMHHKs58ZirSG1eXuhwB2qPLQq8VXm7QRubHHuxiJXUcFq2")),
                        Base64.decode("CFISII2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0GgQQoI0GIICAurvILigD4gYKCgYSBHJpY2gQAQ=="),
                        Base64.decode("CkAIUhIgjY+yjcB1fArFRi26YEYA7BeLB3tUgJK6I9GKMWhjN3QaBBCgjQYggIC6u8guKAPiBgoKBhIEcmljaBABEkCKcsPrOA/Pp1aeI0uKaXwb4TFvAxoXOksJLboVftMLLZQ9NWadkYPh9pc3Q2O+467DsbmvnnFGrObYnQH6b5eB"),
                        "{\"senderPublicKey\":\"AXbaBkJNocyrVpwqTzD4TpUY8fQ6eeRto9k1m2bNCzXV\",\"amount\":1,\"sender\":\"3M4qwDomRabJKLZxuXhwfqLApQkU592nWxF\",\"feeAssetId\":null,\"chainId\":82,\"proofs\":[\"3mYdtrBDiizLESUQ88ZF3Bi9Xt8nM4FwYpDPVfSA5JMHHKs58ZirSG1eXuhwB2qPLQq8VXm7QRubHHuxiJXUcFq2\"],\"fee\":100000,\"recipient\":\"alias:R:rich\",\"id\":\"65jwmmr3Yb3z2iNUMSUQuqF7PRPckhB8Z7MUgQiBXxLh\",\"type\":8,\"version\":3,\"timestamp\":1600000000000}"
                ),
                arguments(3, maxAlias, Long.MAX_VALUE, Id.as("5XXAMNKLxEy3a5Ews3cr4Vzaiw6UTuRUffQTmkDxwpbq"),
                        Proof.list(Proof.as("3rAeZ2PVGxKMjHVfetxLxKeaTAmYCM5AddPzAQ5BhD6iia2d1snAT2pF5grZm7jHWuAFJ2ZxP9VyvzvPv4QwkprL")),
                        Base64.decode("CFISII2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0GgQQoI0GIICAurvILigD4gYsCiASHl9yaWNoLWFjY291bnQud2l0aEAzMF9zeW1ib2xzXxD//////////38="),
                        Base64.decode("CmIIUhIgjY+yjcB1fArFRi26YEYA7BeLB3tUgJK6I9GKMWhjN3QaBBCgjQYggIC6u8guKAPiBiwKIBIeX3JpY2gtYWNjb3VudC53aXRoQDMwX3N5bWJvbHNfEP//////////fxJAjm7kwi6bNKy5edF9kur+ApzwKVpZaWZvcSKRdG+SfnjSbVfR/i2Nf6hSiTRS3BUJz2LilsudZhhZbRGX8NFvgQ=="),
                        "{\"senderPublicKey\":\"AXbaBkJNocyrVpwqTzD4TpUY8fQ6eeRto9k1m2bNCzXV\",\"amount\":9223372036854775807,\"sender\":\"3M4qwDomRabJKLZxuXhwfqLApQkU592nWxF\",\"feeAssetId\":null,\"chainId\":82,\"proofs\":[\"3rAeZ2PVGxKMjHVfetxLxKeaTAmYCM5AddPzAQ5BhD6iia2d1snAT2pF5grZm7jHWuAFJ2ZxP9VyvzvPv4QwkprL\"],\"fee\":100000,\"recipient\":\"alias:R:_rich-account.with@30_symbols_\",\"id\":\"5XXAMNKLxEy3a5Ews3cr4Vzaiw6UTuRUffQTmkDxwpbq\",\"type\":8,\"version\":3,\"timestamp\":1600000000000}"
                ),
                arguments(3, address, Long.MAX_VALUE, Id.as("96peWN7hJLzTRiT68VLxgZtAnw6gHWzX7P9mqmM2B56E"),
                        Proof.list(Proof.as("4hZmtnVwFkj1N5ypgoxmFsvzvgmcr32ffRbuHRv9eWQ5ZeiVP8EoJeitACXHJvitENBHgrGcEtWhM6WRGqabgDLr"), Proof.as("3WtzGAGW2BmWRvJCVQEgKeUyCwpidGiLmnAHXFVzrVL7wkdztZJ8TnBeme643JMUCCC7hURvkt9gpa5NXu7wxXxX"), Proof.as("5qTG4chcuyKGVnYQksyYwz1dCPenqz4jcbo7e51oCkKJ3k19hhdR3UfLsLEJrUAH8oudDdAGV7NDyUcvUW3jCvb2"), Proof.as("3kGPckN5hLuGNvNxhc292WS32dek7pfQ8uUTJC4nfMRvzqyXAtqnrwFtnpZGkVZLXxrqBREaAySD5rpgAGLGcady"), Proof.as("62uijRo8Wo7Z1sBhNNcrhM2jeBLKsKuXpWZRumxD3Pqt4GVzcB5ChYe58chRbxMWcL5R5MReQz9SiBbm9t2XNpFr"), Proof.as("hJUpAhoCqJWhpQBGD5VGeG9wnzH5b8gF1QasFwUg7kTycBQ7qvo7n3qS37XiEi5aYEzxeNRkBARwVb7jNkFce4h"), Proof.as("59Ejnjny6tZ8NHuJfik7wciCNxE2QNwakAnfHrQEdk4cbpzHPHZa5oJ1t3ccj2RVD12kpFmDLMHrC49BxP3sb9Mq"), Proof.as("4M5UhsF2ACXVJV1BmrQg8hUoCdy4YS7XGWHJJxpZzUtMTJ1QUQKw7N99uKGUUPMwrfBG9aMfahvbdLycHhYtAWBr")),
                        Base64.decode("CFISII2Pso3AdXwKxUYtumBGAOwXiwd7VICSuiPRijFoYzd0GgQQoI0GIICAurvILigD4gYiChYKFCeJyYXTXWfWhdwOmLovIW2Gvo+8EP//////////fw=="),
                        Base64.decode(""),
    ...
    void leaseTransaction(int version, Recipient recipient, long amount, Id expectedId, List<Proof> proofs,
