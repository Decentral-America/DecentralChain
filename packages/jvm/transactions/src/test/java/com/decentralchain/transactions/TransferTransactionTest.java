...
public class TransferTransactionTest {
    ...
    static Stream<Arguments> transactionsProvider() {
        ...
        Base58String attachment = new Base58String("zdRB3cqsKNeYxTf1AN4uJhWHe6hyT3DmguhM7oh4rdCjH8w9bbqChPcbTWTzTou9h84yq87Nt6NUGiLdUjpfypy3zSDe4n2DZcuQD2Y2zaUAq1m863kSAUuTYY1HdHyCJkpxE9PbKWAKR68v2WrVqskboaUYQdqaMWWeHDW8Z5c4kDQf3MLJzNSbUWCzu5A");

        long fee = TransferTransaction.MIN_FEE + 1;

        return Stream.of(
                arguments(1, address, assetId, Base58String.empty(), AssetId.DCC, fee, Id.as("6EZtyjhgDk1h367vXz5wr8hNzykrmkkAQ5kYJtL41FwY"),
                ...
                arguments(1, alias, AssetId.DCC, attachment, AssetId.DCC, fee, Id.as("5BiMMPemNvcDkx4jCLPiV5VGycN6toHCQt9Gn5yLYeoF"),
                ...
                arguments(2, address, assetId, Base58String.empty(), AssetId.DCC, fee, Id.as("68hXdLALf181LWJmV8AhUoW5XRmxjG5iG7Hu2PWb5nMT"),
                ...
                arguments(2, alias, AssetId.DCC, attachment, assetId, 2, Id.as("4MnsP1xt96TGPHPNyFW8Mo41FnU2drewHyiCFvavMJDB"),
                ...
                arguments(3, address, assetId, Base58String.empty(), AssetId.DCC, fee, Id.as("CBviNdkSRVnfqXiEH1pzCTyZjPdeCbHoDWuZm28Dcxpm"),
                ...
                arguments(3, alias, AssetId.DCC, attachment, assetId, 2, Id.as("GnjzppeMsiej7Ru5eQC65Q28dwiPWAaks1wjjU1ML4Ps"),
    ...
    void transferTransaction(int version, Recipient recipient, AssetId assetId, Base58String attachment,
        ...
        TransferTransaction builtTx = TransferTransaction
                .builder(recipient, Amount.of(amount, assetId))
        ...
        TransferTransaction constructedTx = new TransferTransaction(sender, recipient, Amount.of(amount, assetId),
                attachment, DccConfig.chainId(), Amount.of(fee, feeAssetId), timestamp, version, proofs);
