...
import io.decentralchain.protobuf.AmountOuterClass;
...
import io.decentralchain.protobuf.transaction.RecipientOuterClass;
...
import io.decentralchain.transactions.serializers.binary.BytesReader;
...
import static io.decentralchain.protobuf.transaction.TransactionOuterClass.DataEntry.ValueCase.*;
import static io.decentralchain.transactions.EthereumTransaction.AMOUNT_MULTIPLIER;
import static io.decentralchain.transactions.EthereumTransaction.ERC20_PREFIX;
...
public abstract class ProtobufConverter {
    ...
    public static Transaction fromProtobuf(SignedTransaction pbSignedTx) throws IOException {
        // NOTE: Ethereum transaction support — to be implemented
