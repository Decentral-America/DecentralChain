...
public class CommitToGenerationTxTest {
  ...
  @Test
  void readCommitToGenerationTransactionByIdTest()
    ...
    CommitToGenerationTransactionInfo ctgTxInfo =
        (CommitToGenerationTransactionInfo)
            node.getTransactionInfo(new Id("2r6kpnJbGqNTmLxi9cPuavgxqumGufnisnN8vhuSCpaX"));
