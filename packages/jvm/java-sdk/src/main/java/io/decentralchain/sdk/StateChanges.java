...
public class StateChanges {
  ...
  public StateChanges(
    ...
    this.data =
        Collections.unmodifiableList(data != null ? new ArrayList<>(data) : new ArrayList<>());
    this.transfers =
        Collections.unmodifiableList(
            transfers != null ? new ArrayList<>(transfers) : new ArrayList<>());
    this.issues =
        Collections.unmodifiableList(issues != null ? new ArrayList<>(issues) : new ArrayList<>());
    this.reissues =
        Collections.unmodifiableList(
            reissues != null ? new ArrayList<>(reissues) : new ArrayList<>());
    this.burns =
        Collections.unmodifiableList(burns != null ? new ArrayList<>(burns) : new ArrayList<>());
    this.sponsorFees =
        Collections.unmodifiableList(
            sponsorFees != null ? new ArrayList<>(sponsorFees) : new ArrayList<>());
    this.leases =
        Collections.unmodifiableList(leases != null ? new ArrayList<>(leases) : new ArrayList<>());
    this.leaseCancels =
        Collections.unmodifiableList(
            leaseCancels != null ? new ArrayList<>(leaseCancels) : new ArrayList<>());
    this.invokes =
        Collections.unmodifiableList(
            invokes != null ? new ArrayList<>(invokes) : new ArrayList<>());
    this.error = error;
  }
  ...
  /**
   * Returns collection of account's {@link DataEntry DataEntries} which were modified after
  ...
  /**
   * Returns collection of output transfers which were triggered after applying transaction.
   * Currently such transfers are supported by ScriptInvocationTransaction only
   *
