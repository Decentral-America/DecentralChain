...
public class TransactionWithStatus {
  ...
  public TransactionWithStatus(Transaction tx, ApplicationStatus applicationStatus) {
    ...
    this.applicationStatus =
        applicationStatus == null ? ApplicationStatus.SUCCEEDED : applicationStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(tx, that.tx) && applicationStatus == that.applicationStatus;
  }
  ...
  public String toString() {
    return "TransactionWithStatus{" + "tx=" + tx + ", applicationStatus=" + applicationStatus + '}';
  }
}
