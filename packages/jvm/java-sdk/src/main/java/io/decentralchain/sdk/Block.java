...
public class Block extends BlockHeaders {
  ...
  public Block(
    ...
    this.fee = fee;
    this.transactions =
        Collections.unmodifiableList(new ArrayList<>(Common.notNull(transactions, "Transactions")));
  }
  ...
  public boolean equals(Object o) {
    ...
    Block block = (Block) o;
    return fee == block.fee && Objects.equals(transactions, block.transactions);
  }
  ...
  public String toString() {
    return "Block{" + "transactions=" + transactions + ", fee=" + fee + "} " + super.toString();
  }
}
