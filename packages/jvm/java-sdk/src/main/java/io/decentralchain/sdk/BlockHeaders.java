...
public class BlockHeaders {
  ...
  public BlockHeaders(
    ...
    this.rewardShares =
        rewardShares == null ? Map.of() : Collections.unmodifiableMap(new HashMap<>(rewardShares));
    ...
    this.features =
        Collections.unmodifiableList(
            features == null ? new ArrayList<>() : new ArrayList<>(features));
  ...
  private void nxtConsensus(Map<String, Object> nxtConsensus) {
    ...
    this.generationSignature =
        gs instanceof String ? new Base58String((String) gs) : Base58String.empty();
  }
