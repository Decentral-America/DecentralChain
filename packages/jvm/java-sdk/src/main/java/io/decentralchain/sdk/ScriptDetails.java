...
public class ScriptDetails {
  ...
  public ScriptDetails(
      @JsonProperty("script") String script, @JsonProperty("scriptComplexity") int complexity) {
  ...
  public boolean equals(Object o) {
    ...
    return complexity == that.complexity && Objects.equals(script, that.script);
  }
  ...
  public String toString() {
    return "ScriptDetails{" + "script='" + script + '\'' + ", complexity=" + complexity + '}';
  }
}
