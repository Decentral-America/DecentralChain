...
public class LeaseTransactionInfo extends TransactionInfo {
  ...
  public LeaseTransactionInfo(
      LeaseTransaction tx, ApplicationStatus applicationStatus, int height, LeaseStatus status) {
  ...
  public String toString() {
    return "LeaseTransactionInfo{" + "status=" + status + "} " + super.toString();
  }
}
