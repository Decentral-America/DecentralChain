...
public class Pairing {
  ...
  public BLST_ERROR aggregate(P2_Affine pk, P1_Affine sig, byte[] msg, byte[] aug) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_aggregate__SWIG_1(swigCPtr, P2_Affine.getCPtr(pk), P1_Affine.getCPtr(sig), msg, aug));
  }
  ...
  public BLST_ERROR mul_n_aggregate(P2_Affine pk, P1_Affine sig, java.math.BigInteger scalar, byte[] msg, byte[] aug) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_mul_n_aggregate__SWIG_1(swigCPtr, P2_Affine.getCPtr(pk), P1_Affine.getCPtr(sig), scalar.toByteArray(), msg, aug));
  }
