...
public class P2 {
  ...
  public P2 hash_to(byte[] msg, String DST, byte[] aug) { blstJNI.P2_hash_to(swigCPtr, msg, DST, aug); return this; }

  public P2 encode_to(byte[] msg, String DST, byte[] aug) { blstJNI.P2_encode_to(swigCPtr, msg, DST, aug); return this; }
