...
let fs = require('fs');
let mpc_params = fs.readFileSync('../groth16_setup/mpc_params_transfer');
...
let leaves = Array(64)
  .fill(0)
  .map(() => utxo_random({ owner: pk, asset_id: 0n, amount: 0n }));
...
const out_note = [
  utxo_random({ asset_id: 0n, amount: 0n, native_amount: part1 }),
  utxo_random({ asset_id: 0n, amount: 0n, native_amount: total_native_amount - part1 }),
];
