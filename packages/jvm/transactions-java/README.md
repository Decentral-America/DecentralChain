<div align="center">
  ...
  [![Maven Central](https://img.shields.io/maven-central/v/io.decentralchain/transactions-java?label=Maven%20Central)](https://central.sonatype.com/artifact/io.decentralchain/transactions-java)
  [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
  [![Java 25](https://img.shields.io/badge/Java-25-orange)](https://openjdk.org/projects/jdk/25/)
  [![CI](https://github.com/Decentral-America/DCC/actions/workflows/transactions-java.yml/badge.svg)](https://github.com/Decentral-America/DCC/actions/workflows/transactions-java.yml)
</div>
...
`transactions-java` is the DecentralChain fork of
[wavesplatform/waves-transactions-java](https://github.com/wavesplatform/waves-transactions-java),
published as `io.decentralchain:transactions-java:1.0.0`.
...
<dependency>
  ...
  <artifactId>transactions-java</artifactId>
...
```kotlin
implementation("io.decentralchain:transactions-java:1.0.0")
```
...
2. **`io.decentralchain` group ID** — published as `io.decentralchain:transactions-java`
