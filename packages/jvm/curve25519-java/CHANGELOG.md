...
All notable changes to `io.decentralchain:curve25519-java` are documented here.
...
### Changed
- Maven coordinates: `com.wavesplatform:curve25519-java` → `io.decentralchain:curve25519-java`
