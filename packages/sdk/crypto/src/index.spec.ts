  ...
  test.each([
    {
      ...
      expected: new Uint8Array([
        1, 63, 237, 149, 42, 91, 83, 113, 186, 155, 5, 146, 240, 150, 46, 156, 73, 159, 126, 132,
        21, 216, 84, 54, 36, 249,
      ]),
    ...
    },
    {
      chainId: 63, // DCC mainnet '?'
      expected: new Uint8Array([
        1, 63, 97, 191, 188, 228, 176, 164, 247, 10, 248, 105, 184, 156, 249, 200, 25, 177, 181, 39,
        138, 1, 132, 163, 189, 48,
      ]),
      publicKey: new Uint8Array([
    ...
    {
      chainId: 33, // DCC testnet '!'
      expected: new Uint8Array([
        1, 33, 97, 191, 188, 228, 176, 164, 247, 10, 248, 105, 184, 156, 249, 200, 25, 177, 181, 39,
        138, 1, 75, 35, 130, 229,
      ]),
      publicKey: new Uint8Array([
        37, 234, 244, 113, 249, 184, 187, 195, 158, 59, 155, 55, 157, 191, 151, 150, 94, 155, 184,
...
describe('verifyAddress', () => {
  test.each([
    ...
    {
      bytes: new Uint8Array([
        1, 63, 195, 81, 58, 112, 28, 21, 103, 134, 161, 21, 153, 7, 211, 102, 109, 204, 57, 139, 50,
        11, 136, 149, 33, 184,
      ]),
      options: { chainId: 63 },
    ...
    {
      bytes: new Uint8Array([
        1, 33, 195, 81, 58, 112, 28, 21, 103, 134, 161, 21, 153, 7, 211, 102, 109, 204, 57, 139, 50,
        11, 182, 143, 143, 65,
      ]),
      options: { chainId: 63 },
