...
<h3 align="center">@decentralchain/types</h3>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@decentralchain/types"><img src="https://img.shields.io/npm/v/@decentralchain/types?color=blue" alt="npm" /></a>
  <a href="./LICENSE"><img src="https://img.shields.io/npm/l/@decentralchain/types" alt="license" /></a>
  <a href="https://bundlephobia.com/package/@decentralchain/types"><img src="https://img.shields.io/bundlephobia/minzip/@decentralchain/types" alt="bundle size" /></a>
  <a href="./package.json"><img src="https://img.shields.io/node/v/@decentralchain/types" alt="node" /></a>
</p>
...
```bash
npm install @decentralchain/types
```

## Quick Start

```typescript
import { TRANSACTION_TYPE, DATA_FIELD_TYPE } from '@decentralchain/types';
