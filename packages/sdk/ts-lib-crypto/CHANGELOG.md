...
- update gitignore for groth16 and fix embedded seed test ([16c3317a9](https://github.com/Decentral-America/DecentralChain/commit/16c3317a9))
...
- Updated @decentralchain/crypto to 2.0.0
