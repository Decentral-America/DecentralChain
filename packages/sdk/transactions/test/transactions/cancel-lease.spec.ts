...
describe('cancel-lease', () => {
  ...
  it('should build from minimal set of params', () => {
    ...
    expect(tx).toMatchObject({ ...cancelLeaseMinimalParams, chainId: 63, fee: 100000, version: 3 });
  });
  ...
  it('Should not create with negative fee', () => {
    expect(() => cancelLease({ ...cancelLeaseMinimalParams, fee: -1 }, stringSeed)).toThrowError(
  ...
  it('Should not create with empty leaseId', () => {
    expect(() =>
      cancelLease({ ...cancelLeaseMinimalParams, leaseId: '' }, stringSeed),
