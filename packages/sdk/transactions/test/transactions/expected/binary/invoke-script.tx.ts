export const invokeScriptBinaryTx = {
  'InvokeScript TX (type 16 v1)  case 1': {
    ...
    Json: {
      ...
      payment: [],
      proofs: [
        '4kcTJ3PTPEbcoa35WWkZG1vtr7qD6StsXASk3zJ1vxFFGu6qy8VNjpmi23juhCkZMrHBekyJUHKj7L3iKk46NKHn',
      ],
  ...
  'InvokeScript TX (type 16 v1)  case 2': {
    ...
    Json: {
      ...
      proofs: [
        '4hfyReG7jzKRMi6QnXNoikrVD148xWCmfWjbSoYhKtWJAuJ9oy8Np5aeDn5Yru5P8nr3PwftonuZjjQGWcCeLUiD',
      ],
      sender: '3MsX9C2MzzxE4ySF5aYcJoaiPfkyxZMg4cW',
      senderPublicKey: 'AXbaBkJNocyrVpwqTzD4TpUY8fQ6eeRto9k1m2bNCzXV',
  ...
  'InvokeScript TX (type 16 v1)  case 3': {
    ...
    Json: {
      ...
      proofs: [
        '2fNW96ZxxyFQenaiewB7NiSmfv2QEqbquET2upDLWKPTuja7YZ6uSnd11yBCCQWkiCJS9iJT9nv12A9L2HvHrQgh',
      ],
      sender: '3MsX9C2MzzxE4ySF5aYcJoaiPfkyxZMg4cW',
      senderPublicKey: 'AXbaBkJNocyrVpwqTzD4TpUY8fQ6eeRto9k1m2bNCzXV',
