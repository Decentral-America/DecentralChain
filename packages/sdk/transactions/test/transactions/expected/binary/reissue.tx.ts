export const reissueBinaryTx = {
  'Reissue TX (type 5 v2)  case 1 maximal values': {
    ...
    Json: {
      ...
      proofs: [
        '2Wi5rUe3YacAHQcdekG2Mv1gD3zLWgSzpcpx5DQpvZTkwjm4UafV8XzKH8LTuQYrGMkQqDRWE74mZeoxs6683jLk',
      ],
  ...
  'Reissue TX (type 5 v2)  case 2 minimal values': {
    ...
    Json: {
      ...
      proofs: [
        '4Ho73mq9mPPq5LBxErNtcs68L42hKWM5QoCmBzPccgiJEaNisjam4oedq3ChkCofAEnsyyb714ormjJpWrLkURCi',
      ],
      quantity: 1,
      reissuable: true,
      sender: '3MsX9C2MzzxE4ySF5aYcJoaiPfkyxZMg4cW',
