...
describe('Validators', () => {
  describe('Atomic validators', () => {
    ...
    it('Valid DCC Address', () => {
      ...
      expect(
        validators.isValidAddress('3PCAB4sHXgvtu5NPoen6EXR5yaNbvsEA8Fj', 'T'.charCodeAt(0)),
      ).toBe(false);
      expect(
        validators.isValidAddress('3PCAB4sHXgvtu5NPoen6EXR5yaNbvsEA8Fj', 'W'.charCodeAt(0)),
      ).toBe(true);
      expect(
        validators.isValidAddress('3PCAB4sHXgvtu5NPoen6EXR5yaNbvsEA8', 'W'.charCodeAt(0)),
      ).toBe(false);
    ...
    it('Valid DCC Alias', () => {
      ...
      expect(validators.isValidAlias('alias:W:helloisalongaliasfortestmorethan30simbols')).toBe(
        false,
      );
    ...
    it('Base58 validator', () => {
      ...
      expect(validators.isBase58('base58:2M251qL2W4rGFLCFadgATboS8EPqyWAN3DjH12AH5Kd1')).toBe(
        false,
      );
    ...
    it('If Else', () => {
      const cond = validators.ifElse(
        validators.isArray,
        (value: Array<unknown>) => value[0],
        () => 'null',
      );
    ...
    it('Validate attachment', () => {
      ...
      expect(
        validators.isAttachment(
          '',
        ),
      ).toBe(false);
