...
export const BuyOrderForm: React.FC = () => {
  ...
  const validate = (): boolean => {
    ...
    if (total > availableBalance) {
      setError(
        `Insufficient balance. Available: ${formatAmount(availableBalance)} ${priceAssetName}`,
      );
      return false;
    }
  ...
  // Pending state for button/input disabled binding
  const buyMutation = {
    ...
    <FormContainer>
      ...
      <FormFields as="form" onSubmit={handleSubmit}>
        ...
        <BalanceRow>
          ...
          <BalanceValue>
            <BalanceAmount>
              {formatAmount(availableBalance)} {priceAssetName}
            </BalanceAmount>
          </BalanceValue>
        </BalanceRow>
