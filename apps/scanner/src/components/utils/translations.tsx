...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    faucet: 'Faucet',
    faucetAddressInvalid: 'Invalid DCC address format',
    faucetAddressLabel: 'Testnet address',
    faucetAddressPlaceholder: 'Enter your DCC testnet address...',
    faucetAddressRequired: 'Address is required',
    faucetAnd: 'and',
    faucetApply: 'apply',
    faucetDescription: 'Fill out your address to receive {amount} DCC on testnet.',
    faucetErrorGeneric: 'Something went wrong. Please try again.',
    faucetNotAvailable: 'The faucet is not available on this network.',
    faucetPrivacyPolicy: 'Privacy Policy',
    faucetProblems: 'If you experience any problems with the faucet, please contact',
    faucetRecaptchaNotice: 'This site is protected by reCAPTCHA and the Google',
    faucetRequestButton: 'Request {amount} DCC',
    faucetSending: 'Sending...',
    faucetSubtitle: 'Get free DCC tokens for development and testing.',
    faucetSuccess: '{amount} DCC sent successfully!',
    faucetTermsOfService: 'Terms of Service',
    faucetTestnetAddress: 'Testnet Address',
    faucetTxId: 'Transaction ID:',
    fee: 'Fee',
  ...
  es: {
    ...
    faucet: 'Faucet',
    faucetAddressInvalid: 'Formato de dirección DCC inválido',
    faucetAddressLabel: 'Dirección testnet',
    faucetAddressPlaceholder: 'Ingresa tu dirección DCC testnet...',
    faucetAddressRequired: 'La dirección es requerida',
    faucetAnd: 'y',
    faucetApply: 'aplican',
    faucetDescription: 'Ingresa tu dirección para recibir {amount} DCC en testnet.',
    faucetErrorGeneric: 'Algo salió mal. Por favor intenta de nuevo.',
    faucetNotAvailable: 'El faucet no está disponible en esta red.',
    faucetPrivacyPolicy: 'Política de Privacidad',
    faucetProblems: 'Si experimentas problemas con el faucet, contacta a',
    faucetRecaptchaNotice: 'Este sitio está protegido por reCAPTCHA y la',
    faucetRequestButton: 'Solicitar {amount} DCC',
    faucetSending: 'Enviando...',
    faucetSubtitle: 'Obtén tokens DCC gratis para desarrollo y pruebas.',
    faucetSuccess: '¡{amount} DCC enviados exitosamente!',
    faucetTermsOfService: 'Términos de Servicio',
    faucetTestnetAddress: 'Dirección Testnet',
    faucetTxId: 'ID de Transacción:',
    fee: 'Tarifa',
